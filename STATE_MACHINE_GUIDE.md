...
**การใช้งาน:**
1. กด **SW1** → เลือก parameter (วนไป Kp → Ki → Kd → Kp)
2. กด **SW3 (Up)** → เพิ่มค่า parameter +0.1
3. กด **SW2 (Down)** → ลดค่า parameter -0.1
4. หลังจากเลือก parameter ครบแล้ว กด **SW1** อีกครั้ง → ไปโหมด Manual PWM

**หมายเหตุ:**
- เครื่องหมาย `>` แสดง parameter ที่กำลังเลือกอยู่
